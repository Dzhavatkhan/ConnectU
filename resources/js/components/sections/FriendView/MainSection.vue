<template>
        ...
        <div class="last:mb-20 font-display text-white bg-grey rounded-xl lg:rounded-2xl">
            ...
            <div class="font-display lg:text-4xl overflow-auto">
                <div v-for="user in users" :key="user.id" class="p-3 lg:p-6 flex items-center gap-3 lg:gap-8 border-light-grey border-b">
                    ...
                    <div class="lg:text-2xl max-lg:w-2/3 grow mr-16 font-medium">
                        {{user.name + ' ' + user.surname}}
                    </div>

                    <div class="max-lg:w-1/3 flex justify-between lg:gap-10">
                        <router-link :to="{name: 'chat', path: '/messanger', query: { sel: user.id }}" class="block">
    ...
    <div class="grow">
        <div class="last:mb-20 font-sans text-white bg-grey rounded-xl lg:rounded-2xl">
            <div class="p-3 lg:p-6 lg:px-8 text-3xl flex justify-between items-center gap-3 lg:gap-8 border-light-grey border-b">
                <div>Заявки</div>
