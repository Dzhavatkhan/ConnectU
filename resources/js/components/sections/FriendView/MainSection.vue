    ...
    <div class="w-full flex flex-col gap-10">
        <div class="">
            <div class=" font-display text-white bg-grey rounded-xl lg:rounded-2xl">
                ...
                <div v-if="friends" class="font-display lg:text-4xl overflow-auto">
                    <div  v-for="friend in friends" :key="friend" class="p-3 lg:p-6 flex items-center gap-4 lg:gap-8 border-light-grey border-b">
                        <div>
                        ...
                        <div class="max-lg:w-1/3 flex justify-between gap-5 lg:gap-10">
                            <div @click="openModal(friend.friend_id, friend.image, friend.name, friend.surname)" class="block">
        ...
        <div class="">
            <div class="last:mb-20 font-display text-white bg-grey rounded-xl lg:rounded-2xl">
                ...
                <div v-if="openMe" v-for="application in applications" class="p-3 lg:p-6 flex items-center gap-4 lg:gap-8 border-light-grey border-b">
                    <div>
                        <img :src="application.me.avatar" alt="" class="w-14 lg:w-20 rounded-full">
                    </div>

                    <div class="max-lg:w-2/3 lg:text-3xl grow font-medium">
                        {{ application.me.friend }}
                    </div>
                ...
                <div v-if="openMy" v-for="application in applications" class="p-3 lg:p-6 flex items-center gap-4 lg:gap-8 border-light-grey border-b">
                    <div>
                        <img :src="application.my.avatar" alt="" class="w-14 lg:w-20 rounded-full">
                    </div>
                    <div class="max-lg:w-2/3 lg:text-3xl grow font-medium">
...
let friendsAPI = async() => {
    ...
    try {
        ...
        for(let index = 0; index < applications.value.length; index++) {
            if (applications.value[index].friend[0]) {
                if (!friends.value) {
                    friends.value = []
                }
...
let deleteFriend = async(userId) => {
    try {
        ...
        for (let index = 0; index < friends.value.length; index++) {
            ...
            if (friends.value[index].friend_id == userId) {
